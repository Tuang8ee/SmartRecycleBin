...
EECON2 equ 018Dh ;# 
	...
	FNCALL	_MCU_Config,_UART_Writes
	FNCALL	_MCU_Config,_strlen
	FNCALL	_UART_BASE_Init,___aldiv
	FNCALL	_Startup_Infor,_GPIO_Write
	FNCALL	_Loop,_GPIO_Read
	FNCALL	_Loop,_GPIO_Write
	FNCALL	_Loop,_Motor_Forward_Start
	FNCALL	_Loop,_Motor_Reverse_Start
	FNCALL	_Loop,_UART_Writes
	FNCALL	_Loop,_UltraSonicSensor_Read
	FNCALL	_Loop,___llmod
	FNCALL	_Loop,_sprintf
	FNCALL	_Loop,_strlen
	FNCALL	_sprintf,___lwdiv
	FNCALL	_sprintf,___lwmod
	FNCALL	_UltraSonicSensor_Read,_GPIO_Read
	FNCALL	_UltraSonicSensor_Read,_GPIO_Write
	FNCALL	_UART_Writes,_UART_WriteChar
...
Startup_Infor@GPIO:	; 1 bytes @ 0x8
	global	UART_Writes@len
UART_Writes@len:	; 2 bytes @ 0x8
	ds	1
...
Motor_Reverse_Start@motor_handle:	; 1 bytes @ 0x2
	global	UART_Writes@i
UART_Writes@i:	; 1 bytes @ 0x2
...
UltraSonicSensor_Read@buff_time:	; 4 bytes @ 0x4
	ds	1
...
UltraSonicSensor_Read@sensor:	; 1 bytes @ 0x8
	ds	1
...
??_Loop:	; 1 bytes @ 0x13
	ds	3
	global	Loop@TX_Str
Loop@TX_Str:	; 10 bytes @ 0x16
	ds	10
	global	Loop@moto
Loop@moto:	; 1 bytes @ 0x20
	ds	1
	global	Loop@timeSysTick
Loop@timeSysTick:	; 1 bytes @ 0x21
	ds	1
	global	Loop@d
Loop@d:	; 1 bytes @ 0x22
	ds	1
	global	main@systick_flag
main@systick_flag:	; 4 bytes @ 0x23
	ds	4
;!
;!Data Sizes:
;!    Strings     20
...
;!		 -> Loop@TX_Str(BANK0[10]), STR_2(CODE[11]), 
;!
...
;!
;!    UART_Writes@data	PTR const unsigned char  size(2) Largest target is 11
;!		 -> Loop@TX_Str(BANK0[10]), STR_1(CODE[11]), 
;!
;!    Loop@timeSysTick	PTR unsigned long  size(1) Largest target is 4
;!		 -> timeSysTick(BANK0[4]), 
;!
...
;!		 -> Motor_4(BANK1[8]), Motor_3(BANK1[8]), Motor_2(BANK0[8]), 
;!
...
;!                                              0 BANK0      2     2      0
;! ---------------------------------------------------------------------------------
;! (2) _UltraSonicSensor_Read                               10     9      1    5241
;!                                              7 COMMON     1     0      1
;!                                              0 BANK0      9     9      0
;!                          _GPIO_Read
;!                         _GPIO_Write
;! ---------------------------------------------------------------------------------
;! (3) _GPIO_Read                                            3     2      1     671
;!                                              2 COMMON     3     2      1
;! ---------------------------------------------------------------------------------
;! (2) _UART_Writes                                          7     3      4     415
;!                                              6 COMMON     4     0      4
;!                                              0 BANK0      3     3      0
;!                     _UART_WriteChar
;!                             _strlen (ARG)
...
;!                                              2 COMMON     1     1      0
;! ---------------------------------------------------------------------------------
;! (2) _Motor_Reverse_Start                                  2     2      0    8549
;!                                              1 BANK0      2     2      0
;!                         _GPIO_Write
;!                         _Motor_Stop
;! ---------------------------------------------------------------------------------
;! (2) _Motor_Forward_Start                                  2     2      0    8549
;!                                              1 BANK0      2     2      0
;!                         _GPIO_Write
;!                         _Motor_Stop
;! ---------------------------------------------------------------------------------
;! (3) _Motor_Stop                                           4     4      0    4368
;!                                              7 COMMON     3     3      0
;!                                              0 BANK0      1     1      0
;!                         _GPIO_Write
;! ---------------------------------------------------------------------------------
;! (3) _GPIO_Write                                           5     3      2    3936
;!                                              2 COMMON     5     3      2
;! ---------------------------------------------------------------------------------
...
;;  systick_flag    4   35[BANK0 ] unsigned long 
...
l7067:	
	...
	movwf	(main@systick_flag+3)
	movlw	low highword(0)
	movwf	(main@systick_flag+2)
	movlw	high(0)
	movwf	(main@systick_flag+1)
	movlw	low(0)
	movwf	(main@systick_flag)
...
l7071:	
	bcf	status, 5	;RP0=0, select bank0
	movf	(_timeSysTick+3),w	;volatile
	xorwf	(main@systick_flag+3),w
	skipz
	goto	u2045
	movf	(_timeSysTick+2),w	;volatile
	xorwf	(main@systick_flag+2),w
	skipz
	goto	u2045
	movf	(_timeSysTick+1),w	;volatile
	xorwf	(main@systick_flag+1),w
	skipz
	goto	u2045
	movf	(_timeSysTick),w	;volatile
	xorwf	(main@systick_flag),w
u2045:
	skipz
	goto	u2041
	goto	u2040
...
;; Defined at:
;;		line 35 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\Configuration.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l7023:	
	...
	movwf	(UART_Writes@data)
	movlw	80h
	movwf	(UART_Writes@data+1)
	...
	fcall	_strlen
	movf	(1+(?_strlen)),w
	movwf	(UART_Writes@len+1)
	movf	(0+(?_strlen)),w
	movwf	(UART_Writes@len)
	fcall	_UART_Writes
	line	54
...
;; Defined at:
;;		line 10 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
;; Parameters:    Size  Location     Type
;;  baud            4    7[BANK0 ] long 
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 15 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\Configuration.c"
;; Parameters:    Size  Location     Type
...
;; Defined at:
;;		line 26 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\Configuration.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _Loop *****************
;; Defined at:
;;		line 9 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\LoopProcess.c"
;; Parameters:    Size  Location     Type
;;  timeSysTick     1    wreg     PTR unsigned long 
;;		 -> timeSysTick(4), 
;; Auto vars:     Size  Location     Type
;;  timeSysTick     1   33[BANK0 ] PTR unsigned long 
;;		 -> timeSysTick(4), 
;;  TX_Str         10   22[BANK0 ] unsigned char [10]
;;  d               1   34[BANK0 ] unsigned char 
;;  moto            1   32[BANK0 ] unsigned char 
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
;; Registers used:
;;		wreg, fsr0l, fsr0h, status,2, status,0, btemp+1, pclath, cstack
...
l7045:	
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	0+(_Motor_2)+03h,w
	movwf	(??_Loop+0)+0
	movf	(??_Loop+0)+0,w
	movwf	(GPIO_Read@Pin)
	movf	(0+low(_Motor_2|((0x0)<<8)+02h)),w
	fcall	_GPIO_Read
	xorlw	0
	skipnz
	goto	u2001
...
l7057:	
	...
	movlw	(low(Loop@TX_Str|((0x0)<<8)))&0ffh
	fcall	_sprintf
	line	53
	movlw	(low(Loop@TX_Str|((0x0)<<8))&0ffh)
	movwf	(UART_Writes@data)
...
;; This function uses a non-reentrant model
;;
psect	text8,local,class=CODE,delta=2,merge=1,group=3
...
;;		 -> UltraSonic_2(4), 
;;  system_tick     1    7[COMMON] PTR volatile unsigned lo
;;		 -> timeSysTick(4), 
;; Auto vars:     Size  Location     Type
;;  sensor          1    8[BANK0 ] PTR struct .
;;		 -> UltraSonic_2(4), 
;;  buff_time       4    4[BANK0 ] unsigned long 
;; Return value:  Size  Location     Type
...
psect	text13,local,class=CODE,delta=2,merge=1,group=0
	...
	line	12
global __ptext13
__ptext13:	;psect for function _UltraSonicSensor_Read
psect	text13
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UltraSonicSensor.c"
	line	12
...
l6929:	
	...
	incf	fsr0,f
	movf	indf,w
	movwf	(??_UltraSonicSensor_Read+0)+0+2
	incf	fsr0,f
	movf	indf,w
	movwf	(??_UltraSonicSensor_Read+0)+0+3
	movf	(UltraSonicSensor_Read@buff_time),w
	subwf	(??_UltraSonicSensor_Read+0)+0,f
	...
	goto	u1802
u1801:
	subwf	(??_UltraSonicSensor_Read+0)+1,f
u1802:
	...
	goto	u1804
u1803:
	subwf	(??_UltraSonicSensor_Read+0)+2,f
u1804:
	...
	goto	u1806
u1805:
	subwf	(??_UltraSonicSensor_Read+0)+3,f
u1806:

	movf	3+(??_UltraSonicSensor_Read+0)+0,w
	movwf	(UltraSonicSensor_Read@buff_time+3)
	movf	2+(??_UltraSonicSensor_Read+0)+0,w
	movwf	(UltraSonicSensor_Read@buff_time+2)
...
psect	text14,local,class=CODE,delta=2,merge=1,group=0
	...
	line	40
global __ptext14
__ptext14:	;psect for function _GPIO_Read
psect	text14
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\GPIO.c"
	line	40
...
;; *************** function _UART_Writes *****************
;; Defined at:
;;		line 25 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
;; Parameters:    Size  Location     Type
;;  data            2    6[COMMON] PTR const unsigned char 
;;		 -> Loop@TX_Str(10), STR_1(11), 
;;  len             2    8[COMMON] unsigned int 
;; Auto vars:     Size  Location     Type
...
psect	text15,local,class=CODE,delta=2,merge=1,group=0
	...
	line	25
global __ptext15
__ptext15:	;psect for function _UART_Writes
psect	text15
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
	line	25
...
;incstack = 0
	callstack 4
; Regs used in _UART_Writes: [wreg-fsr0h+status,2+status,0+btemp+1+pclath+cstack]
	line	27
...
l6899:	
	movf	(UART_Writes@i),w
	addwf	(UART_Writes@data),w
	movwf	fsr0
	movf	(UART_Writes@data+1),w
	skipnc
	incf	(UART_Writes@data+1),w
	movwf	btemp+1
	fcall	stringtab
...
l6901:	
	movlw	low(01h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(??_UART_Writes+0)+0
	movf	(??_UART_Writes+0)+0,w
	addwf	(UART_Writes@i),f
	
l6903:	
	movf	(UART_Writes@i),w
	movwf	(??_UART_Writes+0)+0
	clrf	(??_UART_Writes+0)+0+1
	movf	1+(??_UART_Writes+0)+0,w
	subwf	(UART_Writes@len+1),w
	skipz
	goto	u1765
	movf	0+(??_UART_Writes+0)+0,w
	subwf	(UART_Writes@len),w
u1765:
	skipnc
	goto	u1761
	goto	u1760
...
l4863:	
	return
	callstack 0
GLOBAL	__end_of_UART_Writes
	__end_of_UART_Writes:
	signat	_UART_Writes,8313
	global	_UART_WriteChar

;; *************** function _UART_WriteChar *****************
;; Defined at:
;;		line 18 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
;; Parameters:    Size  Location     Type
...
psect	text16,local,class=CODE,delta=2,merge=1,group=0
	line	18
global __ptext16
__ptext16:	;psect for function _UART_WriteChar
psect	text16
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
	line	18
...
;; Defined at:
;;		line 31 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\HBrightCtrl.c"
;; Parameters:    Size  Location     Type
...
psect	text17,local,class=CODE,delta=2,merge=1,group=0
	...
	line	31
global __ptext17
__ptext17:	;psect for function _Motor_Reverse_Start
psect	text17
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\HBrightCtrl.c"
	line	31
...
;; Defined at:
;;		line 23 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\HBrightCtrl.c"
;; Parameters:    Size  Location     Type
;;  motor_handle    1    wreg     PTR struct .
;;		 -> Motor_4(8), Motor_3(8), Motor_2(8), 
;; Auto vars:     Size  Location     Type
...
psect	text18,local,class=CODE,delta=2,merge=1,group=0
	line	23
global __ptext18
__ptext18:	;psect for function _Motor_Forward_Start
psect	text18
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\HBrightCtrl.c"
	line	23
...
psect	text19,local,class=CODE,delta=2,merge=1,group=0
	line	11
global __ptext19
__ptext19:	;psect for function _Motor_Stop
psect	text19
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\HBrightCtrl.c"
	line	11
...
psect	text20,local,class=CODE,delta=2,merge=1,group=0
	...
	line	4
global __ptext20
__ptext20:	;psect for function _GPIO_Write
psect	text20
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\GPIO.c"
	line	4
...
;; *************** function _TIM2 *****************
;; Defined at:
;;		line 6 in file "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\Interrupts.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text21,local,class=CODE,delta=2,merge=1,group=0
	...
	line	6
global __ptext21
__ptext21:	;psect for function _TIM2
psect	text21
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\Interrupts.c"
	line	6
...
movlw 1
	...
	skipnc
movlw 1
	addwf	(_timeSysTick+2),f	;volatile
	movlw	0
	skipnc
movlw 1
	addwf	(_timeSysTick+3),f	;volatile
	line	21
	movlw	low(0E1h)
	movwf	(17)	;volatile
	line	22
...
i1l6779:	
# 26 "D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\Interrupts.c"
clrwdt ;# 
psect	text21
	line	28
