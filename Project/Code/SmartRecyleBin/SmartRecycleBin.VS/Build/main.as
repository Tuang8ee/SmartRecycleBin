...
??_TrashDoor_Ctrl:	; 1 bytes @ 0x29
	ds	3
	global	_TrashDoor_Ctrl$4000
_TrashDoor_Ctrl$4000:	; 3 bytes @ 0x2C
	ds	3
...
;!		 -> timeSysTick(BANK0[2]), 
;!
;!    TrashDoor_Ctrl@state	PTR enum E1119 size(1) Largest target is 1
;!		 -> trashDoorState(BANK0[1]), 
;!
;!    TrashDoor_Close@state	PTR enum E1119 size(1) Largest target is 1
;!		 -> trashDoorState(BANK0[1]), 
;!
;!    TrashDoor_Open@state	PTR enum E1119 size(1) Largest target is 1
;!		 -> trashDoorState(BANK0[1]), 
;!
...
;!		 -> doorStepHandle(BANK1[13]), compressStepHandle(BANK1[13]), 
;!
...
;!                          _Step_Stop
;! ---------------------------------------------------------------------------------
;! (3) _TrashDoor_Close                                      2     2      0   28037
;!                                              9 COMMON     1     1      0
;!                                              4 BANK0      1     1      0
;!                         _GPIO_Write
;!                           _Step_Set
...
;! ---------------------------------------------------------------------------------
;! (2) _Compression_Run                                     15    15      0   42082
;!                                             20 BANK0     15    15      0
;!                         _GPIO_Write
;!                           _Step_Set
;!                          _Step_Stop
...
;!                                              2 COMMON     1     1      0
;! ---------------------------------------------------------------------------------
;! (2) _Step_Stop                                            2     2      0    9251
;!                                              7 COMMON     2     2      0
;!                         _GPIO_Write
;! ---------------------------------------------------------------------------------
;! (1) _Step_Set                                             5     5      0    9636
;!                                              8 COMMON     1     1      0
;!                                              0 BANK0      4     4      0
;!                         _GPIO_Write
;!                             ___wmul
...
;; Parameters:    Size  Location     Type
;;  state           1    wreg     PTR enum E1119
;;		 -> trashDoorState(1), 
;;  timeSysTick     1   40[BANK0 ] PTR volatile unsigned in
;;		 -> timeSysTick(2), 
;; Auto vars:     Size  Location     Type
;;  state           1   47[BANK0 ] PTR enum E1119
;;		 -> trashDoorState(1), 
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
;; Registers used:
...
l9168:	
	...
	movwf	(_TrashDoor_Ctrl$4000)
	movf	(1+(?_IRSensor_Read)),w
	movwf	(_TrashDoor_Ctrl$4000+1)
	movf	(2+(?_IRSensor_Read)),w
	movwf	(_TrashDoor_Ctrl$4000+2)
	movf	(_TrashDoor_Ctrl$4000),w
	movwf	(___ftge@ff1)
	movf	(_TrashDoor_Ctrl$4000+1),w
	movwf	(___ftge@ff1+1)
	movf	(_TrashDoor_Ctrl$4000+2),w
	movwf	(___ftge@ff1+2)
	movlw	0x9a
	movwf	(___ftge@ff2)
	movlw	0x99
...
;;		 -> trashDoorState(1), 
;; Auto vars:     Size  Location     Type
;;  state           1    4[BANK0 ] PTR enum E1119
;;		 -> trashDoorState(1), 
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
;; Registers used:
...
;;		 -> doorStepHandle(13), compressStepHandle(13), 
;; Auto vars:     Size  Location     Type
...
psect	text23,local,class=CODE,delta=2,merge=1,group=0
	...
	line	467
global __ptext23
__ptext23:	;psect for function _Disionfection_Run
psect	text23
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\LoopProcess.c"
	line	467
...
psect	text24,local,class=CODE,delta=2,merge=1,group=0
	line	451
global __ptext24
__ptext24:	;psect for function _Disinfection_Ctrl
psect	text24
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\LoopProcess.c"
	line	451
...
psect	text25,local,class=CODE,delta=2,merge=1,group=0
	line	327
global __ptext25
__ptext25:	;psect for function _Compression_Run
psect	text25
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\LoopProcess.c"
	line	327
...
psect	text26,local,class=CODE,delta=2,merge=1,group=1
	...
	line	505
global __ptext26
__ptext26:	;psect for function _sprintf
psect	text26
	file	"E:\Program Files (x86)\Microchip\xc8\v2.36\pic\sources\c90\common\doprnt.c"
	line	505
...
psect	text27,local,class=CODE,delta=2,merge=1,group=2
	...
	line	5
global __ptext27
__ptext27:	;psect for function ___lwmod
psect	text27
	file	"E:\Program Files (x86)\Microchip\xc8\v2.36\pic\sources\c90\common\lwmod.c"
	line	5
...
psect	text28,local,class=CODE,delta=2,merge=1,group=2
	...
	line	5
global __ptext28
__ptext28:	;psect for function ___llmod
psect	text28
	file	"E:\Program Files (x86)\Microchip\xc8\v2.36\pic\sources\c90\common\llmod.c"
	line	5
...
psect	text29,local,class=CODE,delta=2,merge=1,group=0
	...
	line	91
global __ptext29
__ptext29:	;psect for function _UltraSensor_Read
psect	text29
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\LoopProcess.c"
	line	91
...
psect	text30,local,class=CODE,delta=2,merge=1,group=2
	...
	line	5
global __ptext30
__ptext30:	;psect for function ___lwdiv
psect	text30
	file	"E:\Program Files (x86)\Microchip\xc8\v2.36\pic\sources\c90\common\lwdiv.c"
	line	5
...
psect	text31,local,class=CODE,delta=2,merge=1,group=0
	...
	line	12
global __ptext31
__ptext31:	;psect for function _UltraSonicSensor_Read
psect	text31
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UltraSonicSensor.c"
	line	12
...
psect	text32,local,class=CODE,delta=2,merge=1,group=0
	...
	line	40
global __ptext32
__ptext32:	;psect for function _GPIO_Read
psect	text32
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\GPIO.c"
	line	40
...
psect	text33,local,class=CODE,delta=2,merge=1,group=0
	...
	line	37
global __ptext33
__ptext33:	;psect for function _UART_WriteStr
psect	text33
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
	line	37
...
;; This function uses a non-reentrant model
;;
psect	text34,local,class=CODE,delta=2,merge=1,group=3
	file	"E:\Program Files (x86)\Microchip\xc8\v2.36\pic\sources\c90\common\strlen.c"
	line	4
global __ptext34
__ptext34:	;psect for function _strlen
psect	text34
	file	"E:\Program Files (x86)\Microchip\xc8\v2.36\pic\sources\c90\common\strlen.c"
	line	4
...
psect	text35,local,class=CODE,delta=2,merge=1,group=0
	...
	line	21
global __ptext35
__ptext35:	;psect for function _UART_WriteChar
psect	text35
	file	"D:\Projects\Projects\MyWork\ThungRacThongMinh\SmartRecycleBin\Project\Code\SmartRecyleBin\SmartRecycleBin.VS\Peripheral_Libs\Source\UART.c"
	line	21
...
;; This function uses a non-reentrant model
;;
psect	text38,local,class=CODE,delta=2,merge=1,group=2
